...
object ComponentUtil {
    ...
    class alertDialog: SingleLiveEvent<ArrayList<String>>(){
        fun observe(owner: LifecycleOwner, observer: (ArrayList<String>) -> Unit) {
            super.observe(owner, Observer {
                it?.run{
                    observer(it)
                }
    ...
    class alertListDialog: SingleLiveEvent<ArrayList<String>>(){
        fun observe(owner: LifecycleOwner, observer: (ArrayList<String>) -> Unit) {
            super.observe(owner, Observer {
                it?.run{
                    observer(it)
